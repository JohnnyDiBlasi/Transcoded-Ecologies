...
def update_leds(amplitude, time_offset=0):
...
def main():
    ...
    try:
        ...
        while True:
            ...
            # Update LEDs continuously with different phases
            for i in range(0, len(samples), 100):  # Update every 100 samples
                update_leds(samples[i], time_offset)
